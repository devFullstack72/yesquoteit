    ...
    <div class="cs-lp-form">
        ...
        <div class="cls_searchhotl cs-cont-btn">
            <div id="htlfndr-input-5">
                ...
                <a href="<?php echo home_url(); ?>/become-partner?lead_id=<?php echo get_the_ID() ?>" class="btn btn-success" style="color:white;margin:0;padding: 6px 15px;margin-top:-5px;">Become a partner</a>
            </div>
        </div>
