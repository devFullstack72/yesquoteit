...
add_action("yeemail_builder_tab_block_template","yeemail_builder_block_img_box",40);
function yeemail_builder_block_img_box(){
	?>
	<li data-type="img_box">
		<div class="momongaDraggable">
            <i class="dashicons dashicons-id"></i>
            <div class="yeemail-tool-text"><?php esc_html_e("Image Box","yeemail") ?></div>
        </div>
    </li>
	<?php
}
add_filter( 'yeemail_builder_block_html', "yeemail_builder_block_img_box_load" );
function yeemail_builder_block_img_box_load($type){
