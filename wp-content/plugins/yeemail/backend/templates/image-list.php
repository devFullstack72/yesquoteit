...
add_action("yeemail_builder_tab_block_template","yeemail_builder_block_img_list",50);
function yeemail_builder_block_img_list(){
	?>
	<li data-type="img_list">
		<div class="momongaDraggable">
            <i class="dashicons dashicons-images-alt2"></i>
            <div class="yeemail-tool-text"><?php esc_html_e("Image List","yeemail") ?></div>
        </div>
    </li>
	<?php
}
add_filter( 'yeemail_builder_block_html', "yeemail_builder_block_img_list_load" );
function yeemail_builder_block_img_list_load($type){
