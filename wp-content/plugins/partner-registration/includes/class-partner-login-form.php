...
class Partner_Login_Form
{
    ...
    public function show_partner_loggedin_info() {
        if (isset($_SESSION['partner_logged_in']) && $_SESSION['partner_logged_in'] === true) {
            ...
            ?>
            <div class="partner-login-user-area">
                <a href="Javascript:void(0);" class="btn theme-link-color"><i class="fa fa-user"></i> Customer</a>
                <a href="<?php echo home_url() . '/partner-login' ?>" class="btn theme-link-color"><i class="fa fa-briefcase"></i> Provider</a>
            </div>
            <?php
        }
    }
