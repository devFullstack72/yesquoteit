...
add_action("yeemail_builder_tab_block_template","yeemail_builder_block_title",30);
function yeemail_builder_block_title(){
	?>
	<li data-type="title">
		<div class="momongaDraggable">
            <i class="dashicons dashicons-heading"></i>
            <div class="yeemail-tool-text"><?php esc_html_e("Title","yeemail") ?></div>
        </div>
    </li>
	<?php
}
add_filter( 'yeemail_builder_block_html', "yeemail_builder_block_title_load" );
function yeemail_builder_block_title_load($type){
